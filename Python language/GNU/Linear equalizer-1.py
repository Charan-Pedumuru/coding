...
class blk(gr.sync_block):  
    ...
    def __init__(self, bits_per_value=8,bits_per_symbol=2):  
        gr.sync_block.__init__(
            self,
            name='Linear equalizer',   
            in_sig=[np.complex64],
    ...
    def work(self, input_items, bits_per_value, bits_per_symbol):
